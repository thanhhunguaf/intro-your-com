        ...
        <div class="row" style="margin-top: 10px">
            <div class="col-12 col-md-12">
                <div>
                    ...
                    <p style="padding-left:5em"><strong style="padding-left:5em">
                                - KTS chọn tông màu xám nhẹ làm tông màu chủ đạo trải đều từ phòng khách đến phòng ngủ của căn
                            hộ. Những đường thẳng đối xứng của phào chỉ trên tường, không cầu kỳ, không rườm rà nhưng
                            lại tạo sự thu hút cho các bức tường.
                        </strong>
                    </p>
                    <p style="padding-left:5em"><strong style="padding-left:5em">
                                - Đồ nội thất gỗ với cánh pano đặc trưng, một vài ô kính trên cánh tủ bếp cho diện mạo thêm
                            sinh động. Tay nắm tủ được lựa chọn với các hình dáng gọn gàng, chất liệu inox mạ vàng bóng
                            làm tăng thêm phần sang trọng cho không gian.
                        </strong>
                    </p>
                    @for($i = 0; $i < 19; $i++)
                        <p style="text-align: center; margin-top: 10px">
                            <img src="{{ asset('images/hado/' . $i . '.jpg') }}" alt="sample image" width="1000px"
                                 height="626px">
                        </p>
                    @endfor
                </div>
